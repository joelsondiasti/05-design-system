...
interface TextInputProps extends Omit<ComponentProps$1<typeof Input>, 'size'> {
    prefix?: string;
    size?: ComponentProps$1<typeof TextInputContainer>['size'];
}
declare const TextInput: react.ForwardRefExoticComponent<Omit<TextInputProps, "ref"> & react.RefAttributes<HTMLInputElement>>;

declare const ToastContainer: _stitches_react_types_styled_component.StyledComponent<react.FC<Toast$1.ToastProviderProps>, {}, {}, _stitches_react_types_css_util.CSS<{}, {
    colors: {
        white: string;
        black: string;
        gray100: string;
...
interface ToastProps extends ComponentProps$1<typeof ToastContainer> {
    title: string;
    description: string;
    duration?: number;
    open?: boolean;
